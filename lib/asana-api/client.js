...
Client.prototype.request = function (options, callback) {
  ...
  if (this.fields) {
    if (options.method === 'GET') {
      ...
      options.query['opt_fields'] = this.fields.join(',');
    } else {
      options.body = options.body || {};
      options.body['opt_fields'] = this.fields
    }
  }
...
Client.prototype.withFields = function (fields) {
  var clonedClient = this.clone();
  clonedClient.fields = fields;
  return clonedClient;
};
